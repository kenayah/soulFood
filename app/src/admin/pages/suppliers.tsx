      ...
      <div class="overflow-x-auto">
        <table class="table table-zebra">
          ...
          <tbody>
            {list.map((s) => (<>
              <tr>
                <td><span class="block text-right lg:hidden text-xs text-base-content/60 mb-0.5">{s.active ? <span class="badge badge-success badge-xs">Active</span> : <span class="badge badge-ghost badge-xs">Inactive</span>}</span>{s.name}</td>
