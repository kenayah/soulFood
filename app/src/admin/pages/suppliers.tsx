          ...
          <tbody>
            {list.map((s) => (<>
              <tr>
                ...
                <td class="max-md:hidden">{s.active ? <span class="badge badge-success">Active</span> : <span class="badge badge-ghost">Inactive</span>}</td>
                <td>
              ...
              <tr class="md:hidden"><td colspan={7} class="text-xs text-base-content/60 pb-1 pt-0">Status: {s.active ? <span class="badge badge-success badge-sm">Active</span> : <span class="badge badge-ghost badge-sm">Inactive</span>}</td></tr>
            </>))}
            {list.length === 0 && (
              <tr>
