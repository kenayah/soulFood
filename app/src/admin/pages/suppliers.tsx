        ...
        <table class="table table-zebra">
          ...
          <tbody>
            {list.map((s) => (<>
              ...
              <tr class="lg:hidden"><td colspan={7} class="text-xs text-base-content/60 pb-1 pt-0">Status: {s.active ? <span class="badge badge-success badge-sm">Active</span> : <span class="badge badge-ghost badge-sm">Inactive</span>}</td></tr>
            </>))}
            {list.length === 0 && (
              <tr>
